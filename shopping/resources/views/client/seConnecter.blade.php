            ...
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    <form class="mt-3 collapse review-form-box" id="formLogin">
                        ...
                        <button type="submit" class="btn hvr-hover">Se Connecter</button>
                    </form>
                </div>
                <div class="col-sm-6 col-lg-6 mb-3">
                ...
                <div class="col-sm-6 col-lg-6 mb-3 offset-sm-3 offset-lg-3">
                    <div class="Account-address">
                        <div class="title-left">
                            <h3>Se Connecter / Vous n'avez pas encore un compte ? <a href="{{route('creer-compte')}} " style="color: #0e84b5;">Creer un compte</a></h3>
                        </div>
